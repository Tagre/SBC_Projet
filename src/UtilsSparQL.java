...
public class UtilsSparQL {
	...
	public static void searchClasses(Element element, int nbClasses) throws IOException{
		...
		String finSparQl="+a+%3Finstance.%0D%0A%7D%0D%0ALIMIT+1000&format=text%2Fhtml&CXML_redir_for_subjs=121&CXML_redir_for_hrefs=&timeout=30000&debug=on&run=+Run+Query+";
